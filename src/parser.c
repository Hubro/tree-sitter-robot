...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [216] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_keywords_section_repeat1, 2), SHIFT_REPEAT(130),
  [219] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_keywords_section_repeat1, 2), SHIFT_REPEAT(144),
  ...
  [246] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_test_cases_section_repeat1, 2), SHIFT_REPEAT(144),
  ...
  [452] = {.entry = {.count = 1, .reusable = false}}, SHIFT(141),
  ...
  [524] = {.entry = {.count = 1, .reusable = false}}, SHIFT(147),
